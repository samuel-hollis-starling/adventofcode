...
public class FirstQuestion {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        for (int i = 0; i < array.length; i++) {
            ...
            for (int j = 0; j < array[i].length; j++) {
                printGrid(array, i, j);
                int toAdd =
                        toInt(checkHorizontal(array, i, j))
                        + toInt(checkVertical(array, i, j))
                        + toInt(checkBottomRightDiagonal(array, i, j))
                        + toInt(checkBottomLeftDiagonal(array, i, j));
    ...
    public static boolean checkHorizontal(char[][] array, int i, int j) {
        StringBuilder sb = new StringBuilder();
        for (int k = 0; k + j < array[i].length && k < 4; k++) {
            sb.append(array[i][k + j]);
        }
        System.out.println("horizontal: " + sb);
        return sb.toString().replace(" ", "").replace("\n", "").equals("XMAS") || sb.reverse().toString().equals("XMAS");
    }

    public static boolean checkVertical(char[][] array, int i, int j) {
        StringBuilder sb = new StringBuilder();
        for (int k = 0; i + k < array.length && k < 4; k++) {
            sb.append(array[i + k][j]);
        }
        System.out.println("vertical: " + sb);
        return sb.toString().equals("XMAS") || sb.reverse().toString().equals("XMAS");
    }

    public static boolean checkBottomRightDiagonal(char[][] array, int i, int j) {
        StringBuilder sb = new StringBuilder();
        for (int k = 0; i + k < array.length && j + k < array[i].length && k < 4; k++) {
    ...
    public static boolean checkBottomLeftDiagonal(char[][] array, int i, int j) {
        StringBuilder sb = new StringBuilder();
        for (int k = 0; i + k < array.length && j - k >= 0 && k < 4; k++) {
            sb.append(array[i + k][j - k]);
        }
